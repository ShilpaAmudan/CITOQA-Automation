...
public class Verify_Status_BulkUpload {
	...
	public void verifyStatus(String username,String url,String upc,String status) throws InterruptedException, IOException
	{
		...
		Thread.sleep(3000);
		System.out.println("Started  Test case: Verify the status of the UPC- Bulk Upload");
	...
	public  Object[][] loginData() throws IOException {
		...
		Object[][] arrayObject =Wrapper.getXlsData("VerifyUPCStatus_BulkUpload");
		return arrayObject;
	}
}
